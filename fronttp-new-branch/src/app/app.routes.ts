...
import { ResearcherDashboardComponent } from './features/admin/researchers/researchers-management.component';
...
export const appRoutes: Routes = [
  ...
  { path: 'dashboard/moderateur', component: ResearcherDashboardComponent },
